...
public class QArticle extends EntityPathBase<Article> {
    ...
    public final SetPath<ArticleHashtag, QArticleHashtag> articleHashtags = this.<ArticleHashtag, QArticleHashtag>createSet("articleHashtags", ArticleHashtag.class, QArticleHashtag.class, PathInits.DIRECT2);
