...
class ArticleCommentServiceTest {
    ...
    @Test
    void givenArticleCommentInfo_whenSavingComment_thenSaveArticleComment() {
        // Given
        given(articleCommentRepository.save(any(ArticleComment.class))).willReturn(null);

        // When
        sut.saveArticleComment(ArticleCommentDto.of(LocalDateTime.now(), "janghun", LocalDateTime.now(), "janghun", "comment"));
